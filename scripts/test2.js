...
module.exports = async function(finished){
    ...
    try {
        ...
        console.log('Sample bids = [[10,2], [13,1], [7,3], [8,2]];');
        ...
        */
         ...
         for (i = 0; i < bids.length;i++){
             ...
             instance.placeBid(hashedBid[i], {from: accounts[i+1],value: 3000000}); //deposit should not reveal bid value (assumed same for now).
         }
        ...
        var check = async function(){
            ...
            if((tCheck2 - tCheck1) > (bidTime + 1)){
                ...
                // scoring phase
                console.log('\n*********\nRecall: Scoring phase: lowest score wins!!\n*******')
